...
function changeTheme(themeName, toggleOverride = false) {
    ...
    if (themeName == "dark") {
        // Apply dark theme
        jQuery('.radar_image').html('<img style="object-fit:cover;width:650px;height:360px" src="https://maps.aerisapi.com/3ChMxo9b7YcH6otgEM1ae_BwMCmao5AResFejd72N1VMOJGaiN9SbTpktQNkpI/flat-dk,water-depth-dk,counties:60,rivers,interstates:60,admin-cities-dk,alerts-severe:50:blend(lighten),radar:blend(lighten)/650x360/35.34466,-80.97462,8/current.png"></img>');
        ...
        // Apply light theme
        jQuery('.radar_image').html('<img style="object-fit:cover;width:650px;height:360px" src="https://maps.aerisapi.com/3ChMxo9b7YcH6otgEM1ae_BwMCmao5AResFejd72N1VMOJGaiN9SbTpktQNkpI/flat,water-depth,counties:60,rivers,interstates:60,admin-cities,alerts-severe:50:blend(darken),radar:blend(darken)/650x360/35.34466,-80.97462,8/current.png"></img>');
